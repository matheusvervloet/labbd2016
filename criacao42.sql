...
drop table correquisitos;
drop table proposto_por_RC;
drop table faz_credenciamento;
drop table preve_disciplina;
drop table avalia_formulario;
drop table enade;
drop table aula;
drop table ppp;
drop table turma;
drop table decisoes_aprovadas;
drop table comite;
drop table visita;
drop table item_do_formulario;
drop table cursa;
drop table possui_atividade_administrativa;
drop table atividade_administrativa;
drop table possui_recesso_presencial;
drop table possui_recesso_ead;
drop table recesso;
