 			...
 			<main>
 				<div id="content">
 					<div class="innertube">
 						...
 						<p>
								<form action="criarTA.php" method="post"> <! mesmo nome deste arquivo, respectivo a tabela > 
						      ...
						      function insereTA(){ //modificar nome dessa funcao, lembrar de mudar abaixo tambem
								...
								$sql = "call procedure labbd.insereTA($cpf_p, $nome_p, $nome_meio_p, $sobrenome_p)";
